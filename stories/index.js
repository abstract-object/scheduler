...
storiesOf("DayListItem", module)
  ...
  .add("Clickable", () => (
    <DayListItem name="Tuesday" setDay={() => action("setDay")(day.name)} spots={5} />
  ));
...
storiesOf("Appointment", module)
  ...
  .add("Edit", () => <Form name="Jane Doe" interviewers={interviewers} interviewer={3} onSave={action("onSave")} onCancel={action("onCancel")} />)
